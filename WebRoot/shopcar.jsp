...
<!-- 通过动作标识，获取ShopCar类实例 -->
<jsp:useBean id="myCar" class="com.toolJavaBean.ShopCar" scope="session" />
<%
...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<table class="table table-hover" border="0" width="450" rules="none" cellspacing="0"
				cellpadding="0">
				<tr height="50">
				...
				<tr align="center" height="50">
					...
					<td><%=money%></td>
					<td><a
						href="docar.jsp?action=remove&name=<%=single.getName()%>">移除</a>
					</td>
				</tr>
				<%
					}
				...
				<tr height="50" align="center">
					<td colspan="2"><a href="show.jsp">继续购物</a>
					</td>
